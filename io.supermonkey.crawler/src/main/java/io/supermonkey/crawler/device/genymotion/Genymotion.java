...
//		}
	...
	public static org.testobject.runtime.services.provisioning.android.AndroidDevice bootGenymotionDevice(AndroidDebugBridgeFactory androidDebugBridgeFactory) throws IOException {
		...
		GenymotionDevice device = androidGenymotionDeviceFactory.create(Device.DeviceRequest.from(getDescriptor()), initVideoCallback, Device.BootProcessListener.Factory.stub(), Device.CloseListener.Factory.stub(), Device.OrientationCallback.Factory.stub());
		...
		Genyshell shell = new Genyshell(genymotionLocation, device.getIP());
